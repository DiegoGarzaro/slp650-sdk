...
| `MediaBadge` | SLP-NB/NR/NWB, 70×54 mm | 180.00 × 136.224 | 750 × 567 |
| `MultiPurpose` | SLP-MRL, 51×28 mm | 126.00 × 68.40 | 525 × 285 |
| `Return` | SLP-RTN, 45×19 mm | 122.40 × 45.00 | 510 × 187 |
| `Shipping` | SLP-SRL, 101×54 mm | 271.44 × 136.224 | 1131 × 567 |
...
63.5 × 48.0 mm on the 70 × 54 mm badge. Fractional dot sizes are **truncated**
(not rounded) to match the CUPS raster: a MediaBadge capture proved the raster
is 567 dots across, and a 568-tall canvas gets rescaled by cupsfilter, losing
edge rows. AddressSmall (984 × 285) and MediaBadge (750 × 567) are
capture-validated; validate other media the same way before relying on exact
dot geometry.
